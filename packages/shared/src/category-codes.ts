...
export const EXPENSE_CATEGORIES: CategorySeed[] = [
  ...
  // 집계 제외용 특수 분류(지출)
  { code: '18', parentCode: null, name: '지출 분류 제외', type: E, depth: 1, sortOrder: 12 },
];
...
export const INCOME_CATEGORIES: CategorySeed[] = [
  ...
  // 집계 제외용 특수 분류(수입)
  { code: '19', parentCode: null, name: '수입 분류 제외', type: TransactionType.INCOME, depth: 1, sortOrder: 6 },
];
