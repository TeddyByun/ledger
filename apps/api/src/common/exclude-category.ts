...
/**
 * 집계에서 빼는 제외 분류의 이름들. 지출·수입 각각의 '분류 제외'와
 * 구버전 '집계제외'를 모두 인식한다. (사용자가 분류 관리에서 만든 특수 분류)
 */
export const EXCLUDE_CATEGORY_NAMES = ['분류 제외', '집계제외'];
/** @deprecated 하위호환 — EXCLUDE_CATEGORY_NAMES 사용 */
export const EXCLUDE_CATEGORY_NAME = '분류 제외';
