...
#### 분류 코드 시드 데이터 (현행 as-built)
> `packages/shared/category-codes.ts` 가 단일 소스. 실제 운영에서 분류 관리 UI 로 조정된 현재 체계를 반영.

**지출** — 대분류 11개(01~08 · 10 · 11 · 18) + 소분류 24개

| code | parent | name | depth |
|------|--------|------|-------|
| 01 | (NULL) | 대출 | 1 |
| 0101 · 0102 | 01 | 이자 · 원금+이자 | 2 |
| 02 | (NULL) | 투자·저축 | 1 |
| 0201 · 0202 | 02 | 투자 · 적금·청약 | 2 |
| 03 | (NULL) | 보험 | 1 |
| 04 | (NULL) | 공과금·주거 | 1 |
| 0401 · 0402 · 0403 · 0404 | 04 | 관리비 · 전기·가스·수도 · 월세·임차료 · 세금 | 2 |
| 05 | (NULL) | 생활 | 1 |
| 0501 · 0502 · 0503 · 0504 · 0505 · 0507 · 0506 | 05 | 외식 · 카페·간식 · 오프라인쇼핑·마트 · 온라인쇼핑·마트 · 여가·취미·문화 · 구독·디지털 · 기타 | 2 |
| 06 | (NULL) | 통신 | 1 |
| 07 | (NULL) | 건강 | 1 |
| 0701 · 0702 | 07 | 병원 · 약국 | 2 |
| 08 | (NULL) | 교통 | 1 |
| 0801 · 0802 · 0803 · 0804 · 0805 | 08 | 택시 · 대중교통 · 통행료·하이패스 · 주유 · 주차·정비 | 2 |
| 10 | (NULL) | 경조사 | 1 |
| 11 | (NULL) | 교육 | 1 |
| 1101 · 1102 | 11 | 도서·학술 · 강의·콘텐츠 | 2 |
| 18 | (NULL) | 지출 분류 제외 | 1 |
...
| code | name |
|------|------|
| 13 · 14 · 15 · 16 · 17 | 급여 · 상여/추가금 · 캐시백/환급 · 이자 · 기타수입 |
| 19 | 수입 분류 제외 |

> **연혁**: 09 차량 폐지(주유·주차·정비 → 교통 08 하위 0804·0805), 12 여가 폐지(구독·디지털 → 생활 0507, 취미·문화 → 생활 0505 여가·취미·문화). 05 생활의 0503/0504 는 오프라인/온라인 쇼핑으로 재정의, 04 에 0404 세금 추가.

> **거래 연결 규칙**: `transaction`은 가장 하위 코드를 참조한다. 소분류가 있으면 소분류 코드(예: `0501`), 없으면 대분류 코드(예: `03`)를 사용한다.
> **분류 제외(집계 제외)**: 지출 `18` `지출 분류 제외`·수입 `19` `수입 분류 제외` 대분류(타입별로 구분). 이 분류(및 하위)로 지정된 거래는 전체 거래·합계·대시보드 추이 집계에서 제외된다(`common/exclude-category.ts`의 `EXCLUDE_CATEGORY_NAMES` 로 이름 매칭, 구버전 `집계제외` 호환).
...
#### 예시 규칙 (시드 · 현행 체계, priority 작을수록 우선)
> 단일 소스: `packages/shared/merchant-rules.ts`. **온/오프라인 쇼핑 분리** 반영.

| category_code | 대표 pattern | priority |
|---------------|-------------|:--------:|
| 0804 주유 | 주유소 · 주유 · GS칼텍스 · SK에너지 · 오일뱅크 | 10 |
| 0805 주차·정비 | 주차 · 세차 · 카센터 · 정비 | 12 |
| 0803 통행료·하이패스 | 하이패스 · 고속도로 · 도로공사 · 휴게소 · 모바일이즐 | 10 |
| 0801 택시 | 카카오T · 택시 · 티머니 · 캐시비 · 타다 | 14 |
| 0802 대중교통 | 버스 · 지하철 · 코레일 · SRT · 철도 | 16 |
| 0702 약국 / 0701 병원 | 약국 / 의원 · 병원 · 치과 · 한의원 · 클리닉 | 14 / 16 |
| 06 통신 | KT통신요금 · 통신요금 · SKT · LG유플러스 · 알뜰폰 | 20 |
| **0404 세금** | 지방세 · 국세 · 재산세 · 자동차세 · 취득세 · 주민세 · 세무서 | 18 |
| 0401 관리비 / 0402 전기·가스·수도 / 0403 월세 | 관리비 / 한국전력·도시가스 / 월세·임차료 | 20 |
| 1101 도서 / 1102 강의 | 서점·교보문고·알라딘 / 팬딩·인프런·클래스101 | 20 / 22 |
| 0507 구독·디지털 | 넷플릭스 · 유튜브 · 스포티파이 · 구글플레이 · 앱스토어 | 24 |
| 0505 여가·취미·문화 | CGV · 롯데시네마 · 영화 · 노래방 · 헬스 · 필라테스 | 26 |
| **0504 온라인쇼핑·마트** | 쿠팡 · 지마켓 · 11번가 · 컬리 · SSG · 무신사 · 네이버페이 · 스마트스토어 · 알리익스프레스 · 테무 · `_온라인` | 28 |
| **0503 오프라인쇼핑·마트** | 마트 · 이마트 · 코스트코 · GS25 · CU · 홈플러스 · 롯데마트 · 다이소 · 올리브영 · 백화점 | 34 |
| 0502 카페·간식 | 커피 · 카페 · 스타벅스 · 투썸 · 파리바게 · 도넛 | 40 |
| 0501 외식 | 배민 · 국밥 · 피자 · 버거킹 · 롯데리아 · 치킨 · 족발 · 삼겹 | 50 |
| 0506 기타 | 헤어 · 미용 · 네일 · 이발 | 60 |

> **온/오프라인 매칭 순서**: 온라인(0504, p28)을 오프라인 마트(0503, p34)보다 먼저 두어 `코스트코_온라인` 처럼 온라인 접미가 붙은 건은 온라인으로 분류된다.
> 미매칭 가맹점은 `is_classified='N'`으로 남겨 수기 분류하고, "자동분류 키워드 관리"에서 키워드를 추가하면 다음 자동분류부터 학습된다.
...
-- 분류 코드 시드 데이터 (현행 as-built · 단일 소스: packages/shared/category-codes.ts)
INSERT INTO category (code, parent_code, name, type, depth, sort_order) VALUES
  ('01', NULL, '대출',     'expense', 1,  1),
  ('0101','01','이자',     'expense', 2,  1), ('0102','01','원금+이자','expense',2,2),
  ('02', NULL, '투자·저축','expense', 1,  2),
  ('0201','02','투자',     'expense', 2,  1), ('0202','02','적금·청약','expense',2,2),
  ('03', NULL, '보험',     'expense', 1,  3),
  ('04', NULL, '공과금·주거','expense',1,  4),
  ('0401','04','관리비',   'expense', 2,  1), ('0402','04','전기·가스·수도','expense',2,2),
  ('0403','04','월세·임차료','expense',2,  3), ('0404','04','세금','expense',2,4),
  ('05', NULL, '생활',     'expense', 1,  5),
  ('0501','05','외식',     'expense', 2,  1),
  ('0502','05','카페·간식','expense', 2,  2),
  ('0503','05','오프라인쇼핑·마트','expense',2,3),
  ('0504','05','온라인쇼핑·마트','expense',2,4),
  ('0505','05','여가·취미·문화','expense',2, 5),
  ('0507','05','구독·디지털','expense',2,  6),
  ('0506','05','기타',     'expense', 2,  7),
  ('06', NULL, '통신',     'expense', 1,  6),
  ('07', NULL, '건강',     'expense', 1,  7),
  ('0701','07','병원',     'expense', 2,  1), ('0702','07','약국','expense',2,2),
  ('08', NULL, '교통',     'expense', 1,  8),
  ('0801','08','택시',     'expense', 2,  1), ('0802','08','대중교통','expense',2,2),
  ('0803','08','통행료·하이패스','expense',2,3),
  ('0804','08','주유',     'expense', 2,  4), ('0805','08','주차·정비','expense',2,5),
